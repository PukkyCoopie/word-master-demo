...
export const ACHIEVEMENT_DEFINITIONS = Object.freeze([
  ...
  { id: "deck_100", name: "包罗万象", description: "使你字母库中的字母块数增加到100或更高", condition: { kind: "deck_size", threshold: 100 } },
  { id: "deck_40", name: "大道至简", description: "使你字母库中的字母块数减少到40或更低", condition: { kind: "deck_size", threshold: 40, exactLength: false } },
