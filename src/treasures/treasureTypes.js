 ...
 * @property {number} [treasureSlotIndex]
 */
 ...
 * @property {(ctx: TreasureSubmitSuccessContext) => void | Promise<void>} [runSubmitScoringAfterLettersSlotPhase] 计分动画：逐字母全部完成后、字后步开始前，按栏位从左到右（如传真机复制）
