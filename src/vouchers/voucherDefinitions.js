...
const V = [
  ...
  { id: "v_clearance_2", pairId: "clearance", tier: 2, emoji: "🏷️", nameStem: "标签", price: 20, description: "商店商品再优惠 25%", effectKey: "liquidation", inShopPool: true },
  ...
  { id: "v_telescope_1", pairId: "telescope", tier: 1, emoji: "🔭", nameStem: "望远镜", price: 10, description: "升级包中必定出现你最常拼写的长度的升级", effectKey: "telescope", inShopPool: true },
  ...
  { id: "v_grabber_2", pairId: "grabber", tier: 2, emoji: "🧤", nameStem: "手套", price: 20, description: "再 +1 拼写次数", effectKey: "nacho_tong", inShopPool: true },
  ...
  { id: "v_wasteful_2", pairId: "wasteful", tier: 2, emoji: "🗑️", nameStem: "垃圾桶", price: 20, description: "再 +1 丢弃次数", effectKey: "recyclomancy", inShopPool: true },
  ...
  { id: "v_tarot_2", pairId: "tarot", tier: 2, emoji: "✉️", nameStem: "信封", price: 20, description: "法术出现的概率进一步提升", effectKey: "tarot_tycoon", inShopPool: true },
  ...
  { id: "v_planet_2", pairId: "planet", tier: 2, emoji: "🪐", nameStem: "土星", price: 20, description: "升级出现的概率进一步提升", effectKey: "planet_tycoon", inShopPool: true },
  ...
  { id: "v_glyph_2", pairId: "glyph", tier: 2, emoji: "📜", nameStem: "卷轴", price: 20, description: "-1大关；-1丢弃次数", effectKey: "petroglyph", inShopPool: true },
