...
export function buildGamePanelBootstrapDeps(d) {
  return {
    ...
    flushRunSaveNow: d.flushRunSaveNow,
    flushAchievementUnlocks: d.flushAchievementUnlocks,
    openStageSettlement: d.openStageSettlement,
    openRunEnd: d.openRunEnd,
    setSettlementSnapshot: d.setSettlementSnapshot,
    ...
    isSettlementSkipStressDevScenarioActive: d.isSettlementSkipStressDevScenarioActive,
    applySettlementSkipStressOwnedTreasures: d.applySettlementSkipStressOwnedTreasures,
    applySettlementSkipStressRunState: d.applySettlementSkipStressRunState,
    ...
    isVolcanoCometDevScenarioActive: d.isVolcanoCometDevScenarioActive,
    applyVolcanoCometOwnedTreasures: d.applyVolcanoCometOwnedTreasures,
    applyVolcanoCometRunState: d.applyVolcanoCometRunState,
