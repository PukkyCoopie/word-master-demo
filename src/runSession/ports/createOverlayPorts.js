...
export function createOverlayPorts(binding) {
  return Object.freeze({
    ...
    wordFavoriteCtrl: binding.wordFavoriteCtrl,
    showInlineFavoriteButton: binding.showInlineFavoriteButton,
    currentWordFavorited: binding.currentWordFavorited,
    toggleCurrentWordFavorite: binding.toggleCurrentWordFavorite,
