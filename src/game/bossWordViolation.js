...
/** 整词判定类 Boss（选词预览与 Boss 条波纹；格级无效化 Boss 不在此列） */
...
export { BOSS_CLUB_POS_OPTIONS, dictionaryPosMatchesClubKey, inferPosFromTranslationHead, splitDictionaryPosTokens };
