/**
 * 从 design/app-icon-source.png 缩放到 public/favicon.png（256×256）。
...
const SOURCE = join(__dirname, "..", "design", "app-icon-source.png");
const OUT = join(__dirname, "..", "public", "favicon.png");
const OUT_SIZE = 256;

if (!existsSync(SOURCE)) {
  console.error("未找到 design/app-icon-source.png");
  process.exit(1);
}
