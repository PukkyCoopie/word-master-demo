...
const USER_BATCH_50 = [
  ...
  {
    batchIndex: 24,
    text: "$8 epic 所有普通字母提供x1.25倍率（稀有度和倍率在每关结束时都会变化）【普通:1.25，稀有:1.5，史诗2， 传说4，且变化那一下需要wobble】",
  },
  { batchIndex: 25, text: "$6 rare x2倍率，每弃掉1个字母损失0.01（当前x2）" },
  {
    batchIndex: 26,
    text: "$4 common 每一个s提供+5分数和+5倍率；每一个z提供+2分数和x2倍率",
  },
  {
    batchIndex: 27,
  ...
  { batchIndex: 30, text: "$5 common 黄金块提供$4 【出现在随机池和商店的前提：打出一手全部由黄金块组成的单词】" },
  {
    batchIndex: 31,
  ...
  { batchIndex: 39, text: "$7 rare 传说字母提供$10 【解锁前提：在牌库中拥有8个传说字母】" },
  { batchIndex: 40, text: "$7 rare 史诗字母提供x1.5倍率【解锁前提：在牌库中拥有16个史诗字母】" },
  { batchIndex: 41, text: "$7 rare 稀有字母提供+50分数【解锁前提：牌库中一半或以上的字母都是稀有字母】" },
  { batchIndex: 42, text: "$7 rare 普通字母提供+10倍率【解锁前提：牌库中所有字母都是普通字母】" },
  {
    batchIndex: 43,
