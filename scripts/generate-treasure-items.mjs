...
const ITEMS = [
  ...
  ["letter_common_mult", 5, "rare", "绘图铅笔", "✏️", "普通字母在记分时给予+1倍率"],
  ["letter_rare_mult", 5, "rare", "钢笔", "🖋️", "稀有字母在记分时给予+2倍率"],
  ["letter_epic_mult", 5, "rare", "蘸水羽毛笔", "🪶", "史诗字母在记分时给予+4倍率"],
  ["letter_legend_mult", 5, "rare", "冠军奖杯", "🏆", "传说字母在记分时给予+7倍率"],
  ...
  ["random_0_26_mult", 4, "rare", "靶心", "🎯", "随机+0-26倍率"],
  ["last_word_rescore", 5, "epic", "助威喇叭", "📣", "每关最后一个单词会额外触发一次字母计分"],
  ["top_rarity_score_to_mult", 5, "rare", "算盘", "🧮", "会将棋盘中最高的稀有度对应的奖励分数添加至倍率"],
  ["shop_free_refresh", 4, "rare", "入场券", "🎟️", "每次进入商店获得1次免费刷新"],
  ["subset_letters_mult", 8, "epic", "邮简", "💌", "A,B,C,E,H,M,U给予+4倍率"],
  ["per_treasure_mult", 4, "rare", "念珠", "📿", "你每有一个宝藏，+4倍率"],
  ["idle_removal_payout", 4, "rare", "存钱罐", "🐷", "在关卡完成时，如果你没有使用过移除，则每个移除机会会给予你$2"],
  ["retrigger_abcde", 6, "epic", "电钢琴", "🎹", "重新触发所有A,B,C,D,E"],
  ["fragile_mult", 5, "rare", "泡泡棒", "🫧", "+20倍率，在关卡完成时1/6的概率摧毁自身"],
  ["vowel_mode", 5, "epic", "小提琴", "🎻", "所有字母均视为元音字母"],
  ["consonant_mode", 5, "epic", "架子鼓", "🥁", "所有字母均视为辅音字母"],
  ["vowel_flat_score", 5, "rare", "蜂蜜罐", "🍯", "元音字母给予+40分数"],
  ["vowel_flat_mult", 5, "rare", "气球", "🎈", "元音字母给予+4倍率"],
  ["consonant_flat_score", 5, "rare", "卵石", "🪨", "辅音字母给予+40分数"],
  ["consonant_flat_mult", 5, "rare", "冰块", "🧊", "辅音字母给予+4倍率"],
  ...
  ["removal_to_spell_start", 7, "epic", "礼帽", "🎩", "开局时候将你的所有移除机会转换为拼写次数"],
  ["rare_board_mult", 6, "epic", "小油灯", "🪔", "如果棋盘中剩下的都是普通或稀有字母，x3倍率"],
  ["unique_word_score", 5, "rare", "滑板", "🛹", "每当你拼写的单词不包含重复的字母，获得+20分数（当前+0）"],
  ["first_word_dup_legend", 8, "legendary", "双人立牌", "👯", "如果关卡中拼写的第一个单词只有3个字母或更少，则将第一个字母的一个相同的复制洗入字母库"],
  ["tiny_words_ok", 3, "rare", "水果糖", "🍬", "你可以拼写长度为1或2的单词"],
  ["deck_remain_score", 5, "rare", "钓鱼竿", "🎣", "你的字母库中每剩余一个字母，+1分数（当前+0）"],
  ["first_solo_removal_cut", 6, "epic", "裁缝剪", "✂️", "如果关卡的第一次移除只有一个字母，则将其从字母库中永久移除并获得$3"],
];
