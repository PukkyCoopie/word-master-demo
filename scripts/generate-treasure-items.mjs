...
const ITEMS = [
  ...
  ["letter_common_mult", 5, "rare", "绘图铅笔", "✏️", "普通字母提供+1倍率"],
  ["letter_rare_mult", 5, "rare", "钢笔", "🖋️", "稀有字母提供+2倍率"],
  ["letter_epic_mult", 5, "rare", "蘸水羽毛笔", "🪶", "史诗字母提供+4倍率"],
  ["letter_legend_mult", 5, "rare", "冠军奖杯", "🏆", "传说字母提供+7倍率"],
  ...
  ["subset_letters_mult", 8, "epic", "邮简", "💌", "A,B,C,E,H,M,U提供+4倍率"],
  ["per_treasure_mult", 4, "rare", "念珠", "📿", "你每有一个宝藏，+4倍率"],
  ["idle_removal_payout", 4, "rare", "存钱罐", "🐷", "在关卡完成时，如果你没有使用过移除，则每个移除机会会提供$2"],
  ...
  ["vowel_flat_score", 5, "rare", "蜂蜜罐", "🍯", "元音字母提供+40分数"],
  ["vowel_flat_mult", 5, "rare", "气球", "🎈", "元音字母提供+4倍率"],
  ["consonant_flat_score", 5, "rare", "卵石", "🪨", "辅音字母提供+40分数"],
  ["consonant_flat_mult", 5, "rare", "冰块", "🧊", "辅音字母提供+4倍率"],
  ["letter_e_bonus", 4, "rare", "头戴耳机", "🎧", "字母E提供+20分数和+4倍率"],
  ["vowel_gamble_coin", 4, "rare", "老虎机", "🎰", "元音字母有1/2概率使你获得$2"],
  ...
  ["deck_remain_score", 5, "rare", "钓鱼竿", "🎣", "你的牌库中每剩余一个字母，+1分数（当前+0）"],
